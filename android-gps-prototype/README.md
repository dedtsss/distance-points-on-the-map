...
- Shares the selected CSV through the Android share sheet.
- Keeps active session and latest CSV references for session recovery and CSV history.
- Shows recorded CSV tracks on the in-app map.
