...
export function serializePhotoForSession(photo) {
  ...
  return {
    ...
    coordinatePrecision: photo.coordinatePrecision ? { ...photo.coordinatePrecision } : null,
    coordinateText: photo.coordinateText ? { ...photo.coordinateText } : null,
    gpsWarnings: Array.isArray(photo.gpsWarnings) ? [...photo.gpsWarnings] : [],
    ...
    workStatus: photo.workStatus === 'reserve' || photo.disposition === 'reserve' ? 'reserve' : 'active',
    disposition: photo.workStatus === 'reserve' || photo.disposition === 'reserve' ? 'reserve' : 'active',
...
export function createSessionSnapshot({
  ...
  return {
    ...
    sessionNumber: Number(sessionNumber) || undefined,
    createdAt: createdAt || timestamp,
    updatedAt: timestamp,
    thresholdMeters,
    processingSettings: processingSettings ? {
      metadataCleanup: processingSettings.metadataCleanup !== false,
      renameFiles: processingSettings.renameFiles !== false,
      metadataFirst: processingSettings.metadataFirst !== false,
    } : undefined,
    ...
    copiedPhotoIds: Array.isArray(copiedPhotoIds) ? [...new Set(copiedPhotoIds.map(String))] : [],
